                        ...
                        if ($studperc >= $compperc) {
                            ...
                            ?>  
                                ...
                                <p class="lead">Chances of getting placed</p>
                                    ...
                                    <p class="medium text-danger">
                                        <i class="fas fa-exclamation-circle"></i> Make sure you have updated your percentage 
                                    in <b><u>
                                        
                                    <a href="editprofile.php" class="text-danger">Edit Profile</a></u></b> section!
